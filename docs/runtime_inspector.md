...
provides the same pause/resume behavior.
...
changes target connections into committed ones. The spatial panel coexists with the planar and M-Blocks planner panels through
`RuntimeInspectorFrame.spatial_planning`.
