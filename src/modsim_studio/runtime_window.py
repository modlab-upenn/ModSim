...
from modsim_studio.runtime_spatial_planning import SpatialPlanningWorkspace
...
class RuntimeInspectorWindow(QMainWindow):
    ...
    def __init__(self, config: RuntimeInspectorConfig) -> None:
        ...
        self.spatial_planning = SpatialPlanningWorkspace()
        ...
        self.planning_stack.addWidget(self.spatial_planning)
        ...
        self.decisions_stack.addWidget(self.spatial_planning.decisions)
    ...
    def _flush_pending_frames(self) -> None:
        ...
        if frame.spatial_planning is not None:
            self.spatial_planning.set_frame(frame)
            self.planning_stack.setCurrentWidget(self.spatial_planning)
            self.decisions_stack.setCurrentWidget(self.spatial_planning.decisions)
        elif frame.planning is not None:
        ...
        if (
            frame.planning is not None
            or frame.lattice_planning is not None
            or frame.spatial_planning is not None
        ):
    ...
    def _update_run_state(self) -> None:
        ...
        if self._last_error is not None or phase is ReconfigurationPhase.FAILED:
            ...
            color = theme.success
        elif time_limit or phase is ReconfigurationPhase.TIMED_OUT:
            title = (
            ...
            color = theme.warning
        elif self._finished or phase is ReconfigurationPhase.STOPPED:
